...
<div class="col-md-9 col-sm-9 col-xs-9" style="border-right:1px dotted #ddd">
  ...
  /* ===================== Pagination Code Starts ================== */
			...
			$statement = $db->prepare("SELECT * FROM tbl_post WHERE tag_id=? ORDER BY post_id DESC");
			...
			$statement = $db->prepare("SELECT * FROM tbl_post WHERE tag_id=? ORDER BY post_id DESC LIMIT $start, $limit");
			$statement->execute(array($id));
 ...
 <img src="uploads/<?php echo $row['post_image']; ?>" alt="" width="200" style="float:left; margin-right:15px;"/>
 <?php /*?> <?php echo $row['post_description']; ?><?php */?>
  ...
  <p><span class="text-success"> Comments :
  ...
  &nbsp;|&nbsp;</span><a href="index2.php?id=<?php echo $row['post_id']; ?>">Cotinue reading</a></p>
  <p>&nbsp;</p>
